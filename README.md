...
#### Assignement 1 in https://github.com/AbhishekSSrivastava/RepData_PeerAssessment1
...
### Introduction
  ...
  - This analysis is performed through PA1_template.Rmd, which is compiled to PA1_template.md which, in turn, generates an HTML output: PA1_template.html. As per assignement instructions, these files are located in the root directory of this GitHub repository (https://github.com/AbhishekSSrivastava/RepData_PeerAssessment1).
